...
/**
 * @brief Класс-обёртка над GridMap Core для создания и обновления "карты" (квадранта).
 *
 * По умолчанию:
 *   - Размер карты: 500×500 метров.
 *   - Разрешение: 0.1 м/пикс (т.е. 5000×5000 ячеек).
 *   - Основной слой называется "road".
 *
 * Параметры можно изменить при инициализации.
 */
