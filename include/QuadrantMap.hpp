 ...
 *
 * Оборачивает grid_map_core::GridMap, позволяя добавлять точки (увеличивая яркость)
...
public:
    ...
    /**
     * @brief Сохраняет квадрант как изображение (PNG) с наложенной цветовой картой.
